...
class UpdateWeatherDatabaseUseCase {
    @Inject
    lateinit var weatherRepository: WeatherRepository

    init {
        DaggerSharedComponent.create().initializeUpdateWeatherUseCase(this)
    }

    suspend fun doWork(params: Params) {
        weatherRepository.updateWeatherDatabase(params.dao, params.weather)
    }
